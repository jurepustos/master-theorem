...
\begin{proof}
    \leanok
    \uses{lemma:not_pos_theta_and_small_o}
...
\begin{proof}
    \leanok
    \uses{lemma:not_asymp_pos_right_dom_of_bounded_below}
    A direct application of \ref{lemma:not_asymp_pos_right_dom_of_bounded_below}.
\end{proof}
...
\begin{proof}
    \leanok
    \uses{lemma:not_asymp_pos_bounded_below_of_right_dom}
    A direct application of \ref{lemma:not_asymp_pos_bounded_below_of_right_dom}.
\end{proof}

\begin{lemma}
    \label{lemma:not_pos_theta_and_small_omega}
    \lean{not_pos_Θ_and_ω}
    \leanok
...
\begin{proof}
    \leanok
    \uses{lemma:not_pos_theta_and_small_omega}
...
\begin{proof}
    \leanok
    \uses{lemma:not_pos_o_and_small_omega}
