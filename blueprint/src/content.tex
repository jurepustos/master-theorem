...
\subsection{Basic asymptotic properties of functions}
...
\begin{theorem}
    ...
    \lean{asymp_bounded_above_below_iff_bounded}
    \leanok
...
\begin{lemma}
    ...
    \lean{asymp_bounded_imp_not_right_dom}
    \leanok
...
\begin{proof}
    \leanok
    \uses{thm:asymp_bounded_above_below_iff_bounded}
