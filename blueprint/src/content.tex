...
\begin{lemma}
    \label{lemma:not_pos_asymp_bounded_below_and_right_dom}
    \lean{not_pos_asymp_bounded_below_and_right_dom}
    \leanok
...
\begin{theorem}
    \label{thm:pos_asymp_bounded_below_imp_not_right_dom}
...
\begin{theorem}
    \label{thm:pos_asymp_right_dom_imp_not_bounded_below}
    \lean{pos_asymp_right_dom_imp_not_bounded_below}
    \leanok
    \uses{def:asymp_pos, def:asymp_bounded_above, def:asymp_right_dom}
    Let $f$ be asymptotically positive. If $f$ is bounded below by $g$, then $f$ 
    is not dominated by $g$.
...
\begin{lemma}
    \label{lemma:not_pos_asymp_bounded_above_and_left_dom}
    \lean{not_pos_asymp_bounded_above_and_left_dom}
    \leanok
...
\begin{theorem}
    \label{thm:pos_asymp_bounded_above_imp_not_left_dom}
...
\begin{theorem}
    \label{thm:pos_asymp_left_dom_imp_not_bounded_above}
    \lean{pos_asymp_left_dom_imp_not_bounded_above}
    \leanok
    \uses{def:asymp_pos, def:asymp_bounded_below, def:asymp_left_dom}
    TODO
\end{theorem}
...
\begin{theorem}
    \label{thm:not_pos_asymp_left_and_right_dom}
    \lean{not_pos_asymp_left_and_right_dom}
    \leanok
