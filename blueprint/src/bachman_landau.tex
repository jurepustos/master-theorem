...
\begin{lemma}
    ...
    \lean{not_asymp_pos_theta_and_o}
    \leanok
...
\begin{lemma}
    ...
    \lean{not_asymp_pos_theta_and_omega}
    \leanok
...
\begin{lemma}
    ...
    \lean{not_asymp_pos_omega_of_theta}
    \leanok
    Let $g$ be asymptotically positive. If $f(x) \in \Theta(g(x))$ then $f(x) \notin \omega(g(x))$.
\end{lemma}
...
\begin{lemma}
    ...
    \lean{not_asymp_pos_o_and_omega}
    \leanok
